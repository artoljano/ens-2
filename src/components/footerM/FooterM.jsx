    ...
    <section className="m-footer">
      <div className="m-footer-container">
        <div className="m-footer-top">
          <div className="m-footer-company">
        ...
        <div className="m-footer-bottom">
          <div className="m-footer-bottom-left">
            <a href="/ens-design/index.html" className="m-footer-link">
              <span>Home</span>
            </a>
            <a href="/ens-design/index.html" className="m-footer-link">
              <span>Products</span>
          ...
          <div className="m-footer-bottom-right">
            <div className="m-footer-links-location">
              <a href="#/contact" className="m-footer-link">
                <div>
                  Tirane, Albania &nbsp;
                  <local-time
            ...
            <a href="#/contact" className="m-footer-link-contact">
              <div>Rr. Qemal Stafa, Nr.162</div>
            </a>
            <a href="#/contact" className="m-footer-link-contact">
              <div>info@ens-al.com</div>
            </a>
            <a className="m-footer-link-contact">
            ...
            <div className="m-social">
              <a
                ...
                target="_blank"
                className="m-social-icon w-inline-block"
              >
              ...
              <a
                ...
                target="_blank"
                className="m-social-icon fb w-inline-block"
              >
